...
function Othercar() {
  return (
    <div>
        <div className="w-full py-10 bg-white text-left -mt-40">

    <div className="w-full  px-4 sm:px-6 lg:px-8 py-8 md:py-4 ml-4 -mt-20">
      <div className="flex justify-between items-end  pb-">
        
        {/* Main Heading */}
        <h2 className="text-4xl sm:text-2xl lg:text-2xl font-extrabold  text-black">
          Other car <br /> 
        </h2>
        ...
        >
          ...
          {/* <FaArrowRight className="text-xs ml-1" /> */}
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-0 gap-y-10 text-center -px- ml-10 ">
